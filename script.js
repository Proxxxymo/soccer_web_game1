...
const screenWidth = 700;  // Updated for a 3x7 grid
...
function drawElements() {
    ...
    ctx.drawImage(ballImg, ballPos.x * cellWidth + (cellWidth - ballImg.width) / 2, ballPos.y * cellHeight + (cellHeight - ballImg.height) / 2);
